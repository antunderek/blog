<div class="card">
    <div style="height: 45vw; overflow: hidden; object-fit: cover; background-color: whitesmoke">
        @if ($article->image !== null)
            <img class="card-img-top text-hide" style="align-self: center; object-fit: cover; overflow: hidden; height: 45vw" src="{{ url(\App\Http\Helpers\FileHandler::returnImagePublicPath($article->image->image_path)) }}" alt="Card image cap">
        @endif
    </div>
    <div class="card-body">
